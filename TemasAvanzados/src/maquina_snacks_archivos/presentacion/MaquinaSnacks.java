...
import maquina_snacks_archivos.servicios.IServicioSnacks;
import maquina_snacks_archivos.servicios.ServicioSnacksArchivos;
import maquina_snacks_archivos.servicios.ServicioSnacksLista;
...
//        IServicioSnacks servicioSnacks = new ServicioSnacksLista();
    ...
    private static boolean ejecutarOpciones(int opcion, Scanner consola, List<Snack> productos, IServicioSnacks servicioSnacks){
        ...
        switch (opcion){
            ...
            case 4 -> mostrarInventarios(consola, servicioSnacks);
            case 5 -> {
    ...
    private static void mostrarInventarios(Scanner consola, IServicioSnacks servicioSnacks){
        servicioSnacks.mostrarSnacks();
    }
